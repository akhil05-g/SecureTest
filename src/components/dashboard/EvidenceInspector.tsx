...
import { Candidate, IntegrityEvent } from '@/types';
import { EvidenceCanvas } from '@/components/dashboard/EvidenceCanvas';
import { CorrelationMatrix } from '@/components/dashboard/CorrelationMatrix';
import { generateEvidenceDetails } from '@/utils/evidenceGenerator';
